        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 items-center">
          <div className="max-w-xl animate-slideUp">
            <div className="mb-8">
              ...
              <p
                className="text-xl text-gray-700 mb-8 animate-slideInLeft"
            ...
            <div className="bg-white p-8 rounded-xl shadow-xl border border-gray-100">
              ...
              <form onSubmit={handleSubmit} className="space-y-4">
                <input
                  type="hidden"
                  name="__vtrftk"
                  value="sid:df196c95e9d2996a71f7731dfbaf2ccc7aa98c48,1729701852"
                />
                <input type="hidden" name="publicid" value="3b6f5cabc8d28af4c862c5e2c4d931c0" />
                ...
                <div>
                  ...
                  <div className="mt-1 relative rounded-md shadow-sm">
                    <input
                      type="text"
                      name="firstname"
                      className="block w-full pr-10 border-gray-300 rounded-md focus:ring-[#235585] focus:border-[#235585]"
                    ...
                    />
                    <User className="absolute inset-y-0 right-0 pr-3 flex items-center pointer-events-none text-gray-400" />
                  </div>
                </div>
                ...
                <div>
                  ...
                  <div className="mt-1 relative rounded-md shadow-sm">
                    ...
                    />
                    <Phone className="absolute inset-y-0 right-0 pr-3 flex items-center pointer-events-none text-gray-400" />
                  </div>
                </div>
                ...
                <div>
                  ...
                  <div className="mt-1 relative rounded-md shadow-sm">
                    ...
                    />
                    <Mail className="absolute inset-y-0 right-0 pr-3 flex items-center pointer-events-none text-gray-400" />
                  </div>
                </div>
                ...
                <div>
                  <button
                    type="submit"
                    className="w-full flex justify-center py-3 px-4 border border-transparent rounded-md shadow-sm text-lg font-medium text-white bg-[#235585] hover:bg-[#1a3f66] focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-[#235585]"
                    disabled={loading}
                  >
